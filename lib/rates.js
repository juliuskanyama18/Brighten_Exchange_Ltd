 ...
 * ============================================================
 *  Fetches USD/EUR/GBP reference rates from ExchangeRate-API and
 *  caches them in MongoDB (via the Rate model) so the site never
 *  needs to call the external API for every customer calculation.
 *
 *  IMPORTANT: this module NEVER touches settings.anchorTshPerTl.
 *  The Brighten anchor is a separate, manually-set business rate.
 *
...
// How long a cached rate is considered fresh before GET /api/rates
// triggers an automatic background-ish refresh.
export const RATE_STALE_MS = 1000 * 60 * 60 * 6; // 6 hours
